...
protocol JDFindCellStyleLiveDelegate {
    
    func findCellStyleLiveMoreClick(_ cell : JDFindCellStyleLive)
}
...
class JDFindCellStyleLive: UITableViewCell {
    ...
    // 代理
    var delegate : JDFindCellStyleLiveDelegate?
...
extension JDFindCellStyleLive {
    ...
    @IBAction func moreClick() {
        ...
        delegate?.findCellStyleLiveMoreClick(self)
    }
}
